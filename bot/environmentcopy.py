...
class BatteryEnv:
    ...
    def reset(self):
        """ Resets the environment to the initial state for a new trial. """
        self.current_step = 0
        self.total_profit = 0.0  # Reset the total profit if needed
        self.battery.reset()  # Resets the battery's state of charge to initial conditions
