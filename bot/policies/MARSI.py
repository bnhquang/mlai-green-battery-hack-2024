...
class MARSI(Policy):
    def __init__(self, short_window_size=15, long_window_size=288, rsi_size=144, rsi_thres=(40, 60), expo=(12, 0.9)):
        """
    ...
    short_window_size=15, long_window_size=288, rsi_size=144, rsi_thres=(40, 60), expo=(12, 0.9)
    """
